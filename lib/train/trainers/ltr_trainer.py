...
class LTRTrainer(BaseTrainer):
    def __init__(self, actor, loaders, optimizer, settings, lr_scheduler=None, use_amp=False, save_epochs=None):
        """
        args:
        ...
        """
        super().__init__(actor, loaders, optimizer, settings, lr_scheduler, save_epochs=save_epochs)
